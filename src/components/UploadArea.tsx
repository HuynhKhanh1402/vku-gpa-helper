    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-surface-light rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="p-8 sm:p-12">
          <div
            className={`relative group cursor-pointer flex flex-col items-center justify-center rounded-xl border-2 border-dashed transition-all duration-300 px-6 py-16 text-center ${
              isDragging
          ...
          >
            ...
            <div className="flex size-16 items-center justify-center rounded-full bg-white shadow-sm mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4 text-sm text-slate-600">
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-cyan-100 text-cyan-700 font-bold text-xs flex-shrink-0">1</span>
                <p>Truy cập trang xem điểm: <a href="https://daotao.vku.udn.vn/sv/diem" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">https://daotao.vku.udn.vn/sv/diem</a></p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-cyan-100 text-cyan-700 font-bold text-xs flex-shrink-0">2</span>
                <p>Đăng nhập bằng tài khoản sinh viên VKU của bạn</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-cyan-100 text-cyan-700 font-bold text-xs flex-shrink-0">3</span>
                <p>Sau khi trang điểm hiển thị đầy đủ, nhấn <kbd className="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-mono">Ctrl + S</kbd> (Windows) hoặc <kbd className="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-mono">Cmd + S</kbd> (Mac) để lưu trang</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-cyan-100 text-cyan-700 font-bold text-xs flex-shrink-0">4</span>
                <p>Chọn định dạng <strong className="font-semibold text-slate-700">Webpage, HTML Only</strong> và lưu file về máy</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-cyan-100 text-cyan-700 font-bold text-xs flex-shrink-0">5</span>
                <p>Kéo thả hoặc chọn file HTML vừa lưu vào khu vực tải lên bên trên</p>
              </div>
            </div>
          </div>
        </div>
